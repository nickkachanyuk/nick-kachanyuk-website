...
Intro(Hook):
- Share some insights that I've gained from doing my project
- Provide a short summary to the following research questions:
	...
	2) Which variables are important in predicting if a water well is functional, needs repair, or non-functional?

Background/Why is this important?
- Talk about specific examples/testimonies from people who endured the water crisis
...
- Talk about how additional variables were created and what is their purpose
...
- If multiple models are to be used; talk about pros and cons of each
...
Limitations/Further project direction 